  ...
  return (
    <div className="bg-light mt-2 text-center">
      <h1 className="display-4">
        ...
        {props.title}<span className="text-info ml-2">TO-DO</span>
      </h1>
    </div>
  )
}
...
const Form = (props) => {
  return (
    <form onSubmit={props.addTask}>
      ...
      <label htmlFpr="input" className="lead text-light">
        Task
      </label>
        <input
          type="text"
        ...
        />
        <div className="invalid-feedback bg-dark p-2">Cannot be empty</div>
...
const Tasks = (props) => {
  return (
    <div>
      <li className="list-group-item lead">{props.task}
        <button onClick={props.remove} className="btn btn-sm
    btn-danger float-right">x</button>
      </li>
